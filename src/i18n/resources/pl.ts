export const pl = {
  ...
  dashboard: {
    ...
    tiles: {
      ...
      dataSubtitle: 'Twoje dane, przenośne',
    },
  ...
  manageVehicle: {
    ...
    saveSuccessBody: 'Pojazd zaktualizowany.',
  ...
  dataPortability: {
    ...
    subtitle: 'Wyeksportuj dane pojazdu do JSON albo zaimportuj wpisy serwisowe z CSV.',
    shareTitle: 'Eksport Vehico',
    exportAction: 'Udostępnij eksport JSON',
    importTitle: 'Import (CSV)',
    importSubtitle: 'Wklej CSV dla wpisów serwisowych. Wymagane kolumny: service_date,title.',
    importPlaceholder:
