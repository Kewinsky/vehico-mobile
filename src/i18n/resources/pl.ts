export const pl = {
  ...
  dashboard: {
    ...
    oilBanner: {
      ...
      remainingDays: "Pozostało ok. {{days}} dni do terminu.",
      remainingKm: "Pozostało ok. {{km}} km do terminu.",
      lastChangeDate: "Ostatnia wymiana: {{date}}",
      lastChangeMileage: "przy {{mileage}}",
      lastChangeWorkshop: "w warsztacie {{workshop}}",
      done: "Wykonane",
      book: "Umów",
...
Szczegółowy raport: https://report.vehico.app/report/example`,
  ...
  fuelingForm: {
    ...
    gasStationPlaceholderShort: "Wybierz stację",
