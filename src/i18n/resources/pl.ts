export const pl = {
  ...
  dashboard: {
    ...
    stats: {
      ...
      lastOilChangeDate: "Data",
      lastOilChangeMileage: "Przebieg",
      lastOilChangeCost: "Koszt",
      noOilChangeEntries: "Brak wpisów wymiany oleju.",
      oilIntervals: "Interwały olejowe",
      oilIntervalsAvgKm: "Średni interwał",
      oilIntervalsAvgMonths: "Średni interwał (mies.)",
      months: "mies.",
  ...
  wheels: {
    title: "Koła",
    currentlyFitted: "Aktualnie na pojeździe",
    addTire: "Dodaj opony",
