export const pl = {
  ...
  auth: {
    ...
    passwordResetEmailSent: "E-mail z resetem hasła został wysłany. Sprawdź swoją skrzynkę.",
    forgotPasswordTitle: "Resetuj hasło",
    forgotPasswordSubtitle: "Wprowadź swój adres e-mail, a wyślemy Ci link do resetowania hasła.",
    sendResetEmail: "Wyślij e-mail resetujący",
    sendingEmail: "Wysyłanie…",
    enterValidEmail: "Proszę wprowadzić prawidłowy adres e-mail",
    resetPasswordEmailSentTitle: "Sprawdź swoją skrzynkę",
    resetPasswordEmailSentBody: "Wysłaliśmy link do resetowania hasła na adres {{email}}. Sprawdź swoją skrzynkę i postępuj zgodnie z instrukcjami.",
    resetPasswordEmailSentHint: "Nie otrzymałeś e-maila? Sprawdź folder spam lub spróbuj ponownie.",
    ...
    signUpSuccess: "Konto utworzone",
    emailConfirmationSent: "Sprawdź swoją skrzynkę e-mail, aby potwierdzić konto",
    emailNotConfirmed: "E-mail niepotwierdzony",
    pleaseConfirmEmail: "Potwierdź swój e-mail przed zalogowaniem",
    signedInSuccessfully: "Zalogowano pomyślnie",
    socialLoginComingSoon: "Logowanie społecznościowe wkrótce",
