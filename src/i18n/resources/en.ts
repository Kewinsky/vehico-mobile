export const en = {
  ...
  dashboard: {
    ...
    stats: {
      ...
      lastOilChangeCost: "Cost",
      noOilChangeEntries: "No oil change entries.",
      oilIntervals: "Oil change intervals",
      oilIntervalsAvgKm: "Avg interval",
      oilIntervalsAvgMonths: "Avg interval (months)",
      months: "mo",
  ...
  wheels: {
    title: "Wheels",
    currentlyFitted: "Currently on vehicle",
    addTire: "Add tires",
    addWheel: "Add rims",
  ...
  publicReport: {
    ...
    configureTitle: "Configure Report",
    vehicleInfo: "What do you want to include in the report?",
    serviceEntries: "Service entries (required)",
    ...
    importFromVehicle: "Import from vehicle",
    maxPhotosReached: "Maximum 30 photos allowed",
    nextButton: "Next",
    ...
    statsIncluded: "Statistics included",
    statsNotIncluded: "Statistics not included",
